...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any
    return filter === "high" ? affairs.filter(affair => affair.priority === filter)
        : filter === "middle" ? affairs.filter(affair => affair.priority === filter)
            : filter === "low" ? affairs.filter(affair => affair.priority === filter)
                : affairs;
